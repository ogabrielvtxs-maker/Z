...
export default function Pomodoro({ currentUser }: PomodoroProps) {
  ...
  return (
    <div id="pomodoro-component" className="bg-slate-900 border border-slate-800 rounded-2xl p-6 text-white shadow-xl max-w-md mx-auto">
      ...
      <div className="relative flex flex-col items-center justify-center my-6">
        <div className="w-48 h-48 rounded-full border-4 border-slate-800 flex flex-col items-center justify-center relative overflow-hidden bg-slate-950/50">
          ...
          <span className="text-4xl font-extrabold font-mono tracking-tight my-1 text-slate-100">
            {formatTime(timeLeft)}
          </span>
